...
export const ko: TemplateLabelDict = {
  ...
  'mmo-progression': {
    ...
    water: '물 (단위)',
    food: '식량 (단위)',
    water_bought: '구매한 물 (단위)',
    food_bought: '구매한 식량 (단위)',
  ...
  'gacha-banner-zones': {
    ...
    cmp4_pickup_rate_pickup: '픽업률 — 프리미엄 픽업',
    fund_free: '티켓 지급',
    ticket_free: '티켓',
    pulls_made_free: '뽑기 횟수',
    zone1_free_w_ssr: '일반(무료) · SSR 가중치',
    zone1_free_w_sr: '일반(무료) · SR 가중치',
    zone1_free_w_r: '일반(무료) · R 가중치',
    sr_count_free: 'SR 횟수',
    r_count_free: 'R 횟수',
    ssr_count_free: '무료 SSR',
    roll_gate_free: '뽑기 판정',
    ssr_hit_free: 'SSR 결과',
    sr_hit_free: 'SR 결과',
    r_hit_free: 'R 결과',
    fund_standard: '티켓 지급',
    ticket_standard: '티켓',
    pulls_made_standard: '뽑기 횟수',
    zone2_standard_w_ssr: '프리미엄 상시 · SSR 가중치',
    zone2_standard_w_sr: '프리미엄 상시 · SR 가중치',
    zone2_standard_w_r: '프리미엄 상시 · R 가중치',
    sr_count_standard: 'SR 횟수',
    r_count_standard: 'R 횟수',
    ssr_count_standard: '상시 SSR',
    roll_gate_standard: '뽑기 판정',
    ssr_hit_standard: 'SSR 결과',
    sr_hit_standard: 'SR 결과',
    r_hit_standard: 'R 결과',
    pity_standard: '천장 카운트',
    zone2_standard_hard_pity: '프리미엄 상시 · 하드 천장',
    forced_ssr_standard: '강제 SSR',
    ceiling_hits_standard: '천장 발동 횟수',
    fund_pickup: '티켓 지급',
    ticket_pickup: '티켓',
    pulls_made_pickup: '뽑기 횟수',
    zone3_pickup_w_ssr: '프리미엄 픽업 · SSR 가중치',
    zone3_pickup_w_sr: '프리미엄 픽업 · SR 가중치',
    zone3_pickup_w_r: '프리미엄 픽업 · R 가중치',
    sr_count_pickup: 'SR 횟수',
    r_count_pickup: 'R 횟수',
    ssr_count_pickup: '픽업 SSR',
    pity_pickup: '천장 카운트',
    zone3_pickup_hard_pity: '프리미엄 픽업 · 하드 천장',
    ceiling_hits_pickup: '천장 발동 횟수',
    missed_pickup_pickup: '픽업 보장 상태',
    zone3_pickup_w_pickup: '프리미엄 픽업 · 픽업 가중치',
    zone3_pickup_w_standard: '프리미엄 픽업 · 일반 가중치',
    roll_normal_open_pickup: '뽑기 — 일반, 보장 없음',
    roll_normal_owed_pickup: '뽑기 — 일반, 보장 있음',
    roll_forced_open_pickup: '뽑기 — 강제, 보장 없음',
    roll_forced_owed_pickup: '뽑기 — 강제, 보장 있음',
    ssr_split_open_pickup: 'SSR 분배 — 보장 없음',
    pickup_hit_pickup: '픽업 적중',
    standard_hit_pickup: '일반 적중',
    sr_hit_pickup: 'SR 결과',
    r_hit_pickup: 'R 결과',
    pickup_count_pickup: '픽업 획득',

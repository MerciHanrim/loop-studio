...
const en = {
  ...
  'templates.equilibrium.blurb':
    'Raw material flows in, production is split between processing and scrap, and finished goods ship out. Re-run it: raw material inventory and finished goods inventory settle within a few steps and the Timeline holds flat.',
  'templates.deadlock.name': 'Capacity deadlock',
  'templates.deadlock.blurb':
    'The same line with no shipment step, so finished goods have nowhere to go. Re-run it: finished goods inventory fills to capacity, raw material inventory backs up to its ceiling, supply is throttled to zero, and the whole line stops.',

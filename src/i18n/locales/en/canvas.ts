...
const canvas = {
  ...
  'palette.pool.description': 'Holds resources and shows the current amount. When its capacity fills, it pushes back on the incoming flow.',
  'palette.source.name': 'Source',
  'palette.source.description': 'Creates new resources each step and sends them to the nodes it feeds.',
  ...
  'palette.gate.description': 'Splits incoming resources by a fixed ratio, or picks one branch by probability and sends there. Holds nothing.',
  'palette.converter.name': 'Converter',
  'palette.converter.description': 'Consumes input resources and produces output resources at the ratio you set. Holds nothing.',
  'palette.end.name': 'End',
  'palette.end.description': 'Stops the run when a resource reaches it.',
  'palette.parameter.name': 'Parameter',
  'palette.parameter.description': 'A fixed number you set. It has no ports, and an expression can reference it by id.',
  'palette.register.name': 'Register',
  'palette.register.description': 'Evaluates an expression for the current step and shows the result. It accumulates nothing, stores nothing and has no ports.',

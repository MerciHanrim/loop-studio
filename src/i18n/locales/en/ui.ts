...
const ui = {
  ...
  'toolbar.settings.button': 'Settings ▾',
  'toolbar.settings.menuLabel': 'Settings',
  ...
  'playbar.mc.cancelled': 'Cancelled',
  'playbar.mc.failed': 'Run failed',
  'playbar.initError': 'Cannot run: {detail}',
  ...
  'share.tooLarge': 'This diagram is too large for a share link ({size}; the limit is {cap}). Use File ▾ → Graph JSON and share the file instead.',
  'share.replacePrompt': 'Open the shared diagram? Your current diagram will be replaced. Export it first if you want to keep it.',
  ...
  'autosave.failed.quota': "Autosave has stopped: this browser's storage is full, so your latest changes are not being saved on this device. Export a file to keep them.",
  'autosave.failed.unavailable': 'Autosave is unavailable: this browser is blocking storage, so changes are not being saved on this device. Export a file to keep them.',
  'autosave.exportButton': 'Export Graph JSON',
  ...
  'import.error.invalidJson': 'This file is not valid JSON.',
  'import.error.unexpected': 'Unexpected file contents.',
  'import.error.notLoopStudio': 'This does not look like a Loop Studio graph file.',
  'import.error.missingNodesEdges': 'Graph file is missing its nodes or edges.',
  'import.structuralWarning': 'This graph has structural problems and those connections are ignored:\n{detail}',
  ...
  'export.projectRevision.blurb': 'the diagram plus a project id and lineage, for offline collaboration',
  ...
  'revision.export.noSecureRandom': 'This browser has no secure random source, so a revision id cannot be created. Nothing was exported.',
  'revision.export.tooLarge': 'This diagram is too large to export as a Project revision ({size}; limit {cap}). Use File ▾ → Graph JSON instead.',
  'proposal.needProject': 'Make a proposal needs an open project. Use File ▾ → Project revision first to create one.',
  'proposal.dirtyOrigin': 'The document has changed since this revision. Use File ▾ → Project revision to pin the changes, then make a proposal.',
  'proposal.tooLarge': 'This proposal is too large to send as one file ({size}; limit {cap}). A plain Graph JSON still works.',
  'export.author.name': 'Set the export author…',
  ...
  'review.gate.versionMismatch': 'This proposal and the open document have different model versions (v1 / v2). It cannot be applied here. You can still open it as a document.',
  ...
  'review.fail.versionMismatch': 'This proposal and the open document have different model versions (v1 / v2), so it cannot be applied here.',
  ...
  'tour.help.feedback': 'Send feedback',
  'tour.help.feedbackAria': 'Send feedback — opens in a new tab',

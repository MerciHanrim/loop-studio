...
const ui = {
  ...
  'review.gate.versionMismatch': 'This proposal uses a different model version than the open document (one uses @parameter references, the other does not). It cannot be applied here. You can still open it as a document.',
  ...
  'review.fail.versionMismatch': 'This proposal uses a different model version than the open document and cannot be applied here.',

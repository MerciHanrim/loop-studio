// docs/data-import.md §DI16/§DI17 — the CSV/TSV import wizard, `pt-BR`.
//
// `planilha` is the Brazilian word for a spreadsheet (`folha de cálculo` is
// European). `tabela` / `linha` / `coluna` throughout.
//
...
// `caractere`; `import.loc.*` is a real table column and reads `coluna`. The
// two never borrow each other's word (`parserLocation.test.ts`). Brazilian
// `caractere` — never the European `carácter` / `caráter`.
//
// Every plural writes an explicit `many` arm: `Intl.PluralRules('pt-BR')` has
...
const dataImport = {
  ...
  'import.delimiterAuto': 'Detectar automaticamente',
  ...
  'import.parseError': 'Este texto não é um CSV/TSV válido: {kind} na linha {line}, caractere {column}.',
  ...
  'import.qs.lead': 'Transforme os números de uma planilha em Parâmetros ajustáveis.',
  'import.qs.body':
    'Cada linha precisa de uma coluna com um ID único. Cada coluna que você marcar como Número vira um Parâmetro por linha. Conectá-los ao seu modelo continua sendo um passo seu depois. Nada é enviado para nenhum servidor, e sua planilha nunca é alterada.',
  ...
  'import.qs.download': 'Baixar CSV de exemplo',
  'import.qs.fullGuide': 'Guia completo',
  'import.qs.fullGuideAria': 'Guia completo — abre no GitHub em uma nova aba',
  'import.qs.sources.summary': 'Como tirar os dados do Planilhas Google ou do Excel',
  'import.qs.sources.sheets': 'Planilhas Google: Arquivo → Fazer download → Valores separados por vírgulas (.csv), ou selecione um intervalo e copie.',
  'import.qs.sources.excel': 'Excel ou Numbers: Salvar como / Exportar para CSV, ou copie um intervalo.',
  'import.qs.sources.privacy':
    'Não use “Publicar na web” em uma planilha privada — isso deixa a planilha visível para qualquer pessoa com o link. Baixar ou copiar mantém tudo privado.',
  ...
  'import.qs.notImported.list': 'Formatação, gráficos, células mescladas ou com vários valores, arquivos .xlsx e sincronização ao vivo. Você mesmo modela como os valores interagem.',
  ...
  'import.issueSummary':
    '{n, plural, one {# problema} many {# de problemas} other {# problemas}} em {m, plural, one {# tabela} many {# de tabelas} other {# tabelas}}. Corrija-os abaixo e pressione Avançar novamente.',
  'import.issueSummaryStale': 'A entrada mudou desde a última verificação — pressione Avançar para verificar de novo.',
  ...
  'import.issue.key-control-char': 'A Chave contém um caractere de controle.',
  ...
  'import.commitError.invalid-result-graph': 'O grafo resultante é inválido — entre em contato com o suporte.',

  'import.menu.import': 'Importar valores de planilha como Parâmetros…',
  'import.menu.manage': 'Atualizar ou gerenciar tabelas importadas…',
  'import.menu.guide': 'Como preparar uma planilha…',
  'import.refresh.manageTitle': 'Gerenciar vínculos de planilha',
  'import.refresh.noBindings': 'Nenhuma tabela de planilha está vinculada ainda.',
  ...
  'import.refresh.review.missing': '{n, plural, one {# linha está faltando nos novos dados} many {# de linhas estão faltando nos novos dados} other {# linhas estão faltando nos novos dados}}',
  ...
  'import.refresh.review.missingChoiceUnlink': 'Manter como está, desvincular da planilha',
  'import.refresh.review.missingChoiceDelete': 'Excluir',
  ...
  'import.refresh.commitError.referenced-node': 'Não é possível excluir o Parâmetro desta linha — ele ainda é referenciado em outro ponto do grafo.',
  'import.refresh.commitError.missing-row-dependency': 'Não é possível desvincular nem excluir esta linha — outra tabela ainda a referencia.',

...
const ko = {
  ...
  'templates.coffeeRoastery.blurb':
    '로스팅·판매·재고의 관계를 단순화해 살펴보는 운영 흐름 시뮬레이션: 생두가 입고되고, 일부는 납품으로 나가며, 나머지는 로스팅해 카페·온라인·리테일로 판매됩니다. 하루 운영 값 다섯 개를 바꾸며 재고와 이익이 어떻게 움직이는지 살펴보세요. 단순화한 시뮬레이션 예제이며 ERP나 실시간 모니터링 시스템이 아닙니다.',

...
const ui = {
  ...
  'review.gate.versionMismatch': '이 제안은 열린 문서와 모델 버전이 다릅니다 (한쪽만 @parameter 참조를 사용합니다). 여기에는 적용할 수 없습니다. 문서로는 열 수 있습니다.',
  ...
  'review.fail.versionMismatch': '이 제안은 열린 문서와 모델 버전이 달라 여기에는 적용할 수 없습니다.',

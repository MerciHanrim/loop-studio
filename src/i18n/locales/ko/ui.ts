...
const ui = {
  ...
  'toolbar.file.button': '파일 ▾',
  'toolbar.file.menuLabel': '파일',
  'toolbar.settings.button': '설정 ▾',
  'toolbar.settings.menuLabel': '설정',
  'theme.rowLabel': '테마',
  'theme.title': '테마: 시스템 / 라이트 / 다크',
  'theme.auto': '◐ 자동',
  'theme.light': '☀ 라이트',
  'theme.dark': '☾ 다크',
  'theme.option.system': '자동',
  ...
  'playbar.mc.cancelled': '취소됨',
  'playbar.mc.failed': '실행 실패',
  'playbar.initError': '실행할 수 없습니다: {detail}',
  ...
  'error.EXPR_SYNTAX.message': '{column}번째 문자에 구문 오류가 있습니다',
  'error.EXPR_UNCLOSED_PAREN.message': '{column}번째 문자의 “(”가 닫히지 않았습니다',
  'error.EXPR_UNCLOSED_REF.message': '{column}번째 문자의 “@\'{\'”가 닫히지 않았습니다',
  'error.EXPR_BAD_ESCAPE.message': '{column}번째 문자의 “\\” 다음에는 “\'}\'” 또는 “\\”가 와야 합니다',
  'error.EXPR_NUMBER_RANGE.message': '{column}번째 문자에 있는 숫자가 너무 큽니다',
  'error.EXPR_BAD_TOKEN.message': '{column}번째 문자에 불필요한 문자가 있습니다',
  'dialog.cancel': '취소',
  'dialog.close': '닫기',
  'share.button': '공유',
  ...
  'autosave.failed.quota': '자동 저장이 중단되었습니다: 이 브라우저의 저장 공간이 가득 차서 최근 변경 사항이 이 기기에 저장되지 않고 있습니다. 파일로 내보내 보관하세요.',
  'autosave.failed.unavailable': '자동 저장을 사용할 수 없습니다: 이 브라우저가 저장소를 차단해 변경 사항이 이 기기에 저장되지 않습니다. 파일로 내보내 보관하세요.',
  'autosave.exportButton': 'Graph JSON 내보내기',
  ...
  'import.error.invalidJson': '이 파일은 올바른 JSON이 아닙니다.',
  'import.error.unexpected': '예상하지 못한 파일 내용입니다.',
  'import.error.notLoopStudio': 'Loop Studio 그래프 파일이 아닌 것 같습니다.',
  'import.error.missingNodesEdges': '그래프 파일에 노드 또는 연결이 없습니다.',
  'import.structuralWarning': '이 그래프에는 구조 문제가 있어 해당 연결은 무시됩니다:\n{detail}',
  ...
  'export.projectRevision.blurb': '다이어그램에 프로젝트 ID와 계보를 더한 오프라인 협업 파일',
  'export.proposal.name': '제안 만들기',
  'export.proposal.blurb': '편집해 돌려보낼 검토용 사본',
  'export.proposal.needRevision': '먼저 Project revision을 내보내세요',
  'revision.export.noSecureRandom': '이 브라우저에는 안전한 난수 소스가 없어 리비전 id를 만들 수 없습니다. 아무것도 내보내지 않았습니다.',
  'revision.export.tooLarge': '이 다이어그램은 Project revision으로 내보내기에 너무 큽니다 ({size}, 한도 {cap}). 대신 파일 ▾ → Graph JSON을 사용하세요.',
  'proposal.needProject': '제안을 만들려면 열린 프로젝트가 필요합니다. 먼저 파일 ▾ → Project revision으로 프로젝트를 만드세요.',
  'proposal.dirtyOrigin': '이 리비전 이후 문서가 바뀌었습니다. 파일 ▾ → Project revision으로 변경을 고정한 뒤 제안을 만드세요.',
  'proposal.tooLarge': '이 제안은 파일 하나로 보내기에 너무 큽니다 ({size}, 한도 {cap}). 일반 Graph JSON은 여전히 사용할 수 있습니다.',
  'export.author.name': '작성자 정보 설정…',
  ...
  'review.gate.versionMismatch': '이 제안과 열린 문서의 모델 버전(v1/v2)이 다릅니다. 여기에는 적용할 수 없습니다. 문서로는 열 수 있습니다.',
  ...
  'review.fail.versionMismatch': '이 제안과 열린 문서의 모델 버전(v1/v2)이 달라 여기에는 적용할 수 없습니다.',
  ...
  'tour.help.feedback': '피드백 보내기 (영문 양식)',
  'tour.help.feedbackAria': '피드백 보내기 (영문 양식) — 새 탭에서 열림',
  'about.createdBy': '제작:',
  ...
  'hint.frameMove.body': '프레임 가장자리를 드래그하면 안의 내용이 함께 이동합니다. Alt를 누른 채 드래그하면 프레임만 이동합니다.',
  'help.contextual.hint.frameMove.name': '프레임 이동',
  'help.contextual.hint.frameMove.desc': '편집 가능한 캔버스에서 그룹 프레임을 처음 선택했을 때 한 번 표시됩니다.',

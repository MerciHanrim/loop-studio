...
const templates = {
  ...
  'templates.gachaBannerZones.blurb': '동일한 200회 뽑기 예산으로 세 가지 배너 규칙을 비교합니다: 천장이 없는 일반(무료) 존, 조정 가능한 하드 천장을 가진 프리미엄 상시 존, 그리고 픽업 보장까지 더해진 프리미엄 픽업 존. 실행하거나 몬테카를로로 돌려 천장과 보장이 결과 분포를 어떻게 바꾸는지 확인하세요.',

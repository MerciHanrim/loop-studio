...
const canvas = {
  'palette.pool.name': '풀',
  'palette.pool.description': '자원을 보관하고 현재 수량을 표시합니다. 용량이 가득 차면 역압이 생겨 들어오는 흐름을 막습니다.',
  'palette.source.name': '소스',
  'palette.source.description': '각 단계마다 새 자원을 만들어 연결된 노드로 보냅니다.',
  'palette.drain.name': '드레인',
  'palette.drain.description': '연결된 노드에서 자원을 끌어와 시스템에서 제거합니다.',
  'palette.gate.name': '게이트',
  'palette.gate.description': '들어온 자원을 고정 비율로 나누거나, 확률에 따라 한 갈래를 골라 보냅니다. 자원을 보관하지 않습니다.',
  'palette.converter.name': '컨버터',
  'palette.converter.description': '설정한 비율에 따라 입력 자원을 소비하고 출력 자원을 만듭니다. 자원을 보관하지 않습니다.',
  'palette.end.name': '엔드',
  'palette.end.description': '자원이 도달하면 실행을 종료합니다.',
  'palette.parameter.name': '파라미터',
  'palette.parameter.description': '직접 설정하는 고정 숫자입니다. 포트가 없으며 표현식에서 ID로 참조할 수 있습니다.',
  'palette.register.name': '레지스터',
  'palette.register.description': '현재 단계에서 표현식을 계산해 그 결과를 표시합니다. 값을 누적하거나 보관하지 않으며 포트가 없습니다.',
  ...
  'node.aria.invalid': '유효하지 않음',
  'node.aria.selected': '선택됨',
  'node.aria.focused': '포커스됨',
  ...
  'canvas.frame.a11y.roledescription': '그룹 프레임',
  'canvas.frame.a11y.roledescriptionAuto': '제안된 그룹 프레임',
  'canvas.frame.a11y.name': '{label}, 노드 {n, plural, other {#개}}',
  'canvas.frame.a11y.desc': 'Enter 또는 Space로 이 프레임을 선택합니다.',
  'canvas.frame.a11y.descSelected': '선택됨. 화살표 키로 프레임과 안의 내용을 함께 이동하고, Shift와 함께 누르면 더 크게 움직입니다. Backspace 또는 Delete로 삭제하고, Escape로 선택을 해제합니다.',
  'canvas.frame.a11y.descReadonly': '읽기 전용 — 이 프레임은 선택하고 읽을 수는 있지만 편집할 수 없습니다.',

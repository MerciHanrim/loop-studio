// docs/localization.md §L3.3 — Canvas surface slice of the `es-419` catalog.
//
...
const canvas = {
  ...
  'palette.addAction': 'Haga clic, o arrastre al lienzo, para agregar uno.',
  ...
  'canvas.frame.a11y.desc': 'Presione Entrar o Espacio para seleccionar este marco.',
  ...
  'rf.node.a11y': 'Presione Entrar o Espacio para seleccionar este nodo. Presione Suprimir para eliminarlo, Escape para cancelar.',
  'rf.node.a11yKeyboard': 'Presione Entrar o Espacio para seleccionar este nodo y luego las teclas de flecha para moverlo. Presione Suprimir para eliminarlo, Escape para cancelar.',
  'rf.edge.a11y': 'Presione Entrar o Espacio para seleccionar esta conexión. Presione Suprimir para eliminarla, Escape para cancelar.',
} as const

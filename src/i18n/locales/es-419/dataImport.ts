// docs/data-import.md §DI16 / §DI17 — the CSV/TSV import wizard, `es-419`.
//
...
const dataImport = {
  ...
  'import.addTable': 'Agregar otra tabla',
  ...
  'import.placement.existingFrame': 'Agregar a un marco existente',
  ...
  'import.linkTables.body':
    'Agregue una segunda tabla y marque una columna como Clave externa para referenciar la Clave de la otra tabla. Su Etiqueta enriquece entonces los nombres generados. Una tabla con dos Claves externas debe elegir cuál agrupa los marcos.',
  ...
  'import.issueSummary':
    '{n, plural, one {# problema} many {# problemas} other {# problemas}} en {m, plural, one {# tabla} many {# tablas} other {# tablas}}. Corríjalos abajo y presione Siguiente otra vez.',
  'import.issueSummaryStale': 'La entrada cambió desde la última revisión: presione Siguiente para revisar de nuevo.',
  ...
  'import.refresh.review.added': '{n, plural, one {se agregará # fila} many {se agregarán # filas} other {se agregarán # filas}}',
  ...
  'import.refresh.review.newColumnValues': '{n, plural, one {se agregará # valor de columna nuevo} many {se agregarán # valores de columna nuevos} other {se agregarán # valores de columna nuevos}}',
  'import.refresh.review.confirmAdd': 'Agregar esta fila',

...
- ◐ Onboarding, part 2 — **v0.8.0-dev** ([`docs/localization.md`](docs/localization.md) — design doc first; the run-status live region, Inspector help text, and the visual-language work already shipped are accessibility / design pieces, not this)
  ...
  - ☐ "Early MMO progression (levels 1–15)" example ([`docs/example-mmo-progression.md`](docs/example-mmo-progression.md) — design doc first) — a shipped play-economy demo graph (combat / deaths / loot / gear / consumables / gold) + a Templates entry; generalised, not game-specific
